...
const services = [
  ...
  },
  {
    ...
    body: "Choose from pre-built campaign bundles that combine Guest Posts and Link Insertions into one coordinated strategy. Available as one-off campaigns and ongoing monthly retainers.",
    tags: ["Guest Posts + Link Insertions", "One-off or Monthly", "AI & LLM Ready"],
    featured: true,
    badge: "Most Popular",
    href: "/packages",
    linkLabel: "See All Campaign Packages →",
  },
];
